...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "투두 인스턴스 생성 요청")
public class CreateTodoInstanceRequest {

  @Schema(description = "정의 ID", required = true)
  private UUID definitionId;

  @Min(value = 1, message = "시퀀스 번호는 1 이상이어야 합니다")
  @Schema(description = "시퀀스 번호 (반복 투두의 경우 몇 번째인지)", example = "1")
  ...
  @Schema(description = "예정일", example = "2025-01-01", required = true)
