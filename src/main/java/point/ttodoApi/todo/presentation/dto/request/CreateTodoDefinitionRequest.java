...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "투두 정의 생성 요청")
public class CreateTodoDefinitionRequest {

  @NotBlank(message = "제목은 필수입니다")
  @Size(max = 255, message = "제목은 255자 이하여야 합니다")
  @Schema(description = "투두 제목", example = "매일 운동하기", required = true)
  ...
  @Schema(description = "반복 규칙 (JSON 형식, NULL이면 1회용)",
  ...
  @Schema(description = "협업 투두 여부", defaultValue = "false")
